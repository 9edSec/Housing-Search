...
async def st_start(message: Message):
    ...
    await message.answer('👋 Привет, успей купить квартиру мечты в ЖК Пушкино Град!\n\nОформите заявку на просмотр/презентацию квартиры по кнопке "Оформить заявку"!\n\nТакже мы для вас приготовили специальный промокод "ДЕЛО", найти вы его можете нажав на кнопку "Мои промокоды"!', reply_markup=rkb.main)
